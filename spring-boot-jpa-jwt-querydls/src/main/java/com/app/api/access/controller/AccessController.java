...
public class AccessController {
    ...
    public ResponseEntity<OauthLoginDto.Response> oauthLogin(@RequestBody OauthLoginDto.Request oauthLoginRequestDto,
        ...
        OauthLoginDto.Response jwtTokenResponseDto = accessFacade
                .oauthLogin(token.getAccessToken(), MemberType.from(oauthLoginRequestDto.getMemberType()));
    ...
    @PostMapping("/logout")
    public ResponseEntity<String> logout(@AuthorizationToken TokenDto token) {
        accessFacade.logout(token.getAccessToken());
